      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Data Table With Brand List</h3>
            <a href="{{ route('brand.create') }}" class="col-lg-offset-4 btn btn-success btn-sm">Add new</a>
          </div>
              ...
              <tbody>
              	...
              	<tr>
	                ...
	                <td>{{-- <a href=""><i class="fa fa-trash-o"></i></a> --}}
				  	<form class="form-group " action="{{ route('brand.destroy', $brand->id) }}" method="post">
				  	@method('DELETE')
            @csrf				  		
